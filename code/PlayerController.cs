...
public sealed class PlayerController : Component
{
    ...
    [Property, Group("Movement Properties"), Description("CS2 Default: false")] private float AutoBunnyhopping {get;set;} = 0;
    ...
    private float Height {get;set;} = 72f;
    private float HeightGoal {get;set;} = 72f;
    ...
    private float InternalMoveSpeed {get;set;} = 250f;
    private Vector3 LastSize {get;set;} = Vector3.Zero;
    public Vector3 WishDir {get;set;} = Vector3.Zero;
    public Vector3 Velocity {get;set;} = Vector3.Zero;
	public Vector2 LookAngle {get;set;} = Vector2.Zero;
	...
	protected override void OnStart()
	{
        ...
        foreach(GameObject child in player.Children)
        {
            ...
            {
                Camera = child.Components.Get<CameraComponent>();
            }
        }
    ...
    private void GroundMove() {
        ...
        if ((AutoBunnyhopping > 0 && Input.Down("Jump")) || Input.Pressed("Jump")) {
	...
	protected override void OnUpdate() {
        ...
        if (Body == null || Camera == null ) return;
        ...
        ControllerInput *= 25;
        LookAngle += new Vector2(Input.AnalogLook.pitch, Input.AnalogLook.yaw) * Preferences.Sensitivity * 0.22f;
